...
function PANEL:Init()
	...
	self.VoteButtons[1]:SetUp( "exclamation", "hatedbymingebags", "This player is hated by MingeBags!" )
	
	self.VoteButtons[2] = vgui.Create( "SpawnMenuVoteButton", self )
	self.VoteButtons[2]:SetUp( "emoticon_smile", "smile", "This player made me LOL!" )
