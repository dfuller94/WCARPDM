...
if ( CLIENT ) then
	...
	killicon.AddFont("weapon_gasgrenade","CSKillIcons","C",Color(100,200,100,255))
	killicon.AddFont("cse_ent_gasgrenade","CSKillIcons",SWEP.IconLetter,Color(100,200,100,255)) //FLASHBANG KILLS ARE THE SEX
end
