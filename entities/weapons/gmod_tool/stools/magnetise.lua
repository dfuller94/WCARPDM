...
function TOOL:LeftClick( trace )
	...
	if SERVER && ( !gamemode.Call( "PlayerSpawnMagnet", self:GetOwner(), trace.Entity:GetModel() ) ) then return end
	...
	if (magnet && magnet:IsValid())	then
		...
		gamemode.Call( "PlayerSpawnedMagnet", self:GetOwner(), trace.Entity:GetModel(), magnet )
		trace.Entity:Remove()
