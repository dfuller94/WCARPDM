...
if ( CLIENT ) then
	...
	killicon.AddFont("molotov","CSKillIcons","J",Color(200,125,0,255))
	killicon.AddFont("weapon_molotov","CSKillIcons","J",Color(200,125,0,255))
end
