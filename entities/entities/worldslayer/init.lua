...
function ENT:Explode()
	util.BlastDamage( self.Entity, self.Entity:GetNWEntity("owner"), self.Entity:GetPos(), 768, 700 )
...
function ENT:Armbomb(planter)
	...
	if (self.Entity:CheckPropFaggotry()==false) then
		...
		self.Arming = 50
		Notify(self.Entity:GetNWEntity("owner"), 1, 3, "Get your props away from the bomb for it to be usable.")
